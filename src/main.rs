    ...
    let block_cursus = Block::new("#Cursus")
                        ...
                        .cartBox(CartBox::new()
                            ...
                            .card(CardGeneric::new("Après quelques autres entreprises j'ai signé pour la SEF touraine depuis 2016")
                                .image("https://www.reorev.fr/sites/default/files/styles/illustration_miniature_carre/public/ged/defaut_3.jpg?itok=RYCE0ktV")
                                .subtitle("Je fais de la préstation chez FAIVELEY WABTEC"))
                            .card(CardGeneric::new("Depuis cette année je prépare un diplome de développeur chez Studi")
                                .image("https://www.studyrama.com/pro/sites/default/files/articles/studi.png")
                                .subtitle("J'y fait un titre RNCP niveau 6, sur du Python")))
                        .cartBox(CartBox::new()
                            .text("Veux tu revenir au menu ?")
                            .button_postback("Oui 👍", "#CvStart")
                            .button_postback("Non 👎", "#Nop")); 
